...
class VL53L5CX:
    def __init__(self, i2c, addr=0x29, lpn=None):
        ...
        self._distance_fmt = ""
        self._distance = None
        self.config_data = ConfigData(name="vl53l5cx/" + ("vl53l5cx_fw.bin"
                                      if self._id == VL53L5CX_ID
                                      else "vl53l8cx_fw.bin"))
    ...
    def _rd_multi(self, reg, size):
        return bytearray(size)

    def _wr_multi(self, reg, buf):
        pass
